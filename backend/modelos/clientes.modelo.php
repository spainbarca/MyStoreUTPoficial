...
class ModeloClientes{
    ...
    static public function mdlMostrarClientesNuevos($tabla, $item, $valor){

		$stmt = Conexion::conectar()->prepare("SELECT * FROM clientes WHERE direccion='' OR email='' OR documento=0 OR telefono='' OR fecha_nacimiento=''");
