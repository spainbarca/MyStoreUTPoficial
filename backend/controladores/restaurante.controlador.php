...
class ControladorRestaurante{
	...
	static public function ctrMostrarJaladores($item, $valor){

		$tabla = "restaurante";

		$respuesta = ModeloRestaurante::mdlMostrarJaladores($tabla, $item, $valor);
	...
	static public function ctrVentasJaladores($item, $valor){

		$tabla = "restaurante";

		$respuesta = ModeloRestaurante::mdlVentasJaladores($tabla, $item, $valor);

		return $respuesta;

	}

	static public function ctrTotalVentasJaladores($item, $valor){

		$tabla = "restaurante";

		$respuesta = ModeloRestaurante::mdlTotalVentasJaladores($tabla, $item, $valor);
