...
if(localStorage.getItem("capturarRango") != null){
          ...
          url:"Ajax/productos.ajax.php",
            ...
            success:function(respuesta){
              ...
              $(".nuevoProducto").append(
                  ...
                  '</div>' +
                  '<!-- Precio del producto -->'+
                  '<div class="col-lg-2 ingresoPrecio" style="padding-left:0px">'+
  ...
  function sumarTotalPrecios(){
    ...
    $("input[name='nuevoTotalVenta']").val(sumaTotalPrecio);
  ...
  $("#nuevoMetodoPago").change(function(){
      ...
      $(this).parent().parent().removeClass("col-xs-4");
          ...
          $(this).parent().parent().parent().children(".cajasMetodoPago").html(
               ...
               '<div class="col-xs-4 input-group mb-3" id="capturarCambioEfectivo" style="padding-left:5px">'+
  ...
  $(".tablas").on("click", ".btnEditarVenta", function(){
      ...
      window.location = "index.php?pagina=editar-venta&idVenta="+idVenta;
  })
  ...
  $('#daterange-btn').daterangepicker(
    ...
    function (start, end) {
      ...
      window.location = "index.php?pagina=ventas&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
    }
  )
  ...
  $(".my-rating-9").starRating({
    ...
    onLeave: function(currentIndex, currentRating, $el){
      ...
      console.log("valor",$('.live-rating').val());

      $("#rate").val($('.live-rating').val());
      $("input[name='rate']").val($('.live-rating').val());
    }
