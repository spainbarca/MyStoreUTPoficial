 <div class="content-wrapper" style="min-height: 717px;">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Gestor Empresa</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="inicio">Inicio</a></li>
            <li class="breadcrumb-item active">Gestor Empresa</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card card-primary card-outline">
       ...
       <div class="card-header pl-2 pl-sm-3">
        ...
        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#crearRestaurante">Crear nuevo rol empresarial</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header bg-info">
        <h4 class="modal-title">Crear Rol Empresarial</h4>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="form-group my-2">
            ...
            <div class="btn btn-default btn-file">
                ...
                <i class="fas fa-paperclip"></i> Adjuntar Imagen del trabajador
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control input-lg" name="nuevoResponsable" placeholder="Agregar responsable" required>  
...
<div class="modal" id="editarRestaurante">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header bg-info">
        <h4 class="modal-title">Editar Rol Empresarial</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="form-group my-2">
            ...
            <div class="btn btn-default btn-file">
                ...
                <i class="fas fa-paperclip"></i> Adjuntar Imagen del rol empresarial
